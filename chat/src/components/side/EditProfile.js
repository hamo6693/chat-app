...
class EditProfile extends React.Component{
    ...
    onSubmit = e => {
     ...
     //اعادة تعيين الاسم عند اغلاق النافذة الجانبية
     onClose = e => {
        ...
        return(
            ...
            <div className="d-flex flex-column overflow-auto">
              ...
              <div className="bg-white px-4 py-2">
                 ...
                 <Input defaultValue={this.state.name} name='name' onChange={this.onChange} required autoComplete="off" />
              </div>

              <div className="bg-white px-3 py-2">
                 <label className="text-muted">رسالة الحالة</label>
                 <Input defaultValue={this.state.about} name='about' onChange={this.onChange} required autoComplete="off" />
              </div>
